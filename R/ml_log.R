...
alpha         = param[7]
mu            = function(x,y) (x^(-alpha)+y^(-alpha))^(1/alpha)
dxdymu        = function(x,y) (x^(-alpha)+y^(-alpha))^(1/alpha)*
y^(-alpha)*x^(-alpha)/(y*(x^(-alpha)+y^(-alpha))^2*x)-(x^(-alpha)+
y^(-alpha))^(1/alpha)*x^(-alpha)*y^(-alpha)*alpha/(x*(x^(-alpha)+y^(-alpha))^2*y)
